...
public class FillInfoForTest {
    static void fill() {
        ...
        EntityDao userDao =  Factory.getInstance().getUserDao();
        userDao.add(user1);
        userDao.add(user2);
        userDao.add(user3);

        EntityDao commentDao = Factory.getInstance().getCommentDAO();
        ...
        Factory.getInstance().getAdminDao()
        ...
        EntityDao orderDao = Factory.getInstance().getOrderDao();
